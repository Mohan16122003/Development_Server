...
vendorTransaction.post('/createvendorbill', vendorBillPost); // for creating vendor bill
...
vendorTransaction.get('/getpaymentofbill', getPatmentofBill);
vendorTransaction.post('/createvendorbillpayment', vendorBillPaymentPost); // for vendor bill payment create
