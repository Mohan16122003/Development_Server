...
const UnPlannedLeavesList = ({ empId, setCurrentRender }) => {
  ...
  const handleNewSubmit = async (e) => {
    ...
    if (
      data?.jobRole == undefined ||
      data?.jobRole == '' ||
      data?.jobRole == 'Please Select role'
    ) {
        ...
        <div className="content container-fluid">
          ...
          <div className="page-header">
            <div className="row align-items-center">
              <div className="col">
                <h3 className="page-title">Unplanned Leaves Employees</h3>
                <ul className="breadcrumb">
                  ...
                  <li
                    ...
                    onClick={() => setCurrentRender('default')}
                    role="button"
                  >
                    Attendance
                  </li>
                  <li className="breadcrumb-item active">
                    Unplanned Leaves Employee
                  </li>
                </ul>
              </div>
            </div>
...
export default UnPlannedLeavesList;
