...
const PendingLeavesList = ({empId,setCurrentRender}) => {
        ...
        <div className="content container-fluid">
          ...
          <div className="page-header">
            <div className="row align-items-center">
              <div className="col">
                <h3 className="page-title">Pending Leaves Employee</h3>
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Pending Leaves Employee</li>
                </ul>
              </div>
            </div>
          </div>
