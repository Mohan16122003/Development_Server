...
const RecordMileage = () => {
  ...
  const [invoiceId, setInvoiceId] = useState(
    `REF-${Math.ceil(Math.random() * 100000)}`
  );
      ...
      if (selectedFiles) {
        ...
        UploadFileService.upload(currentFile)
          .then((res) => {
            ...
            return httpService.post(`/vendortrx/createvendorexpense`, {
              ...expenseData,
              fileInfos: [...fileInfos, res?.data],
            });
          })
          .then((res) => history.goBack())
          .catch((err) => {
        ...
        httpService
          .post(`/vendortrx/createvendorexpense`, { ...expenseData })
          .then((res) => history.goBack())
          .catch((err) => {
            console.log(err);
          });
