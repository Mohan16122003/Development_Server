  ...
  const columns = [
    {
      ...
      align: 'center',
      render: (paymentDate) => <span>{dateFormatter(paymentDate)}</span>,
    },
    {
      title: 'PAYMENT#',
      dataIndex: 'paymentNo',
    ...
    },
    {
      ...
      render: (vendorId) => (
        <span key={vendorId?._id}>
          ...
          <Link
            to={
              vendorId.vendorType == 'landowner'
                ? `/app/land-bank/profile/${vendorId?._id}`
                : `/app/profile/vendor-profile/${vendorId?._id}`
            }
          >
            {vendorId?.name}
          </Link>
              ...
              <div className="col-auto float-right ml-auto">
                <Link
                  to={{
                    ...
                    state: { length: paymentData.length },
                  }}
        ...
        <div className="row filter-row justify-content-between">
          ...
          <div className="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-12">
            <button
              ...
              onClick={(e) => {
                setqdatefrom(''), setqdateto(''), setqvendor(''), setqpayno('');
              }}
            >
              Reset
            </button>
