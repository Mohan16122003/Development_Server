...
const Purchase = ({ match }) => (
  <Switch>
    ...
    <Route
      exact
      path={`${match.url}/creditvbill`}
      component={VendorCreditToBill}
    />
    <Route
      exact
      path={`${match.url}/recurringbills`}
      component={RecurringBillsView}
    />
    <Route
      exact
      path={`${match.url}/recurringbillInfo/:id`}
      component={RecurringBillInfo}
    />
    <Route
      exact
      path={`${match.url}/addrecurringbill`}
    ...
    <Route
      exact
      path={`${match.url}/addmileageexpense`}
      component={RecordMileage}
    />
    <Route exact path={`${match.url}/expenses`} component={ExpensesView} />
    <Route
      exact
      path={`${match.url}/recurringexpenses`}
      component={RecurringExpenseView}
    />
    <Route
      exact
      path={`${match.url}/addrecurringexpense`}
      component={AddRecurringExpense}
    />
    <Route
      exact
      path={`${match.url}/recurringexpenseinfo/:id`}
      component={RecurringExpenseInfo}
    />
    <Route
      exact
      path={`${match.url}/expenseinfo/:id`}
    ...
    <Route
      exact
      path={`${match.url}/purchaseorderinfo/:id`}
      component={PurchaseOrderInfo}
    />
    <Route
      exact
      path={`${match.url}/vendorcredit`}
      component={VendorCreditView}
    />
    <Route
      exact
      path={`${match.url}/addvendorcredit`}
      component={AddVendorCredit}
    />
    <Route
      exact
      path={`${match.url}/vendorcreditinfo/:id`}
      component={VendorCreditInfo}
    />
