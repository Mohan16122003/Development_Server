...
const SalesRoute = ({ match }) => (
  <Switch>
    ...
    <Route
      path={`${match.url}/createsalesorder/`}
      component={CreateSalesOrder}
    />
    <Route
      path={`${match.url}/salesorder-info/:id`}
      component={SalesOrderInfo}
    />
    <Route path={`${match.url}/deliverychallan/`} component={DeliveryChallan} />
    <Route
      path={`${match.url}/createdeliverychallan/`}
      component={CreateDeliveryChallan}
    />
    <Route
      path={`${match.url}/deliverychallan-info/:id`}
      component={DeliveryChallanInfo}
    />
    ...
    />
    <Route
      path={`${match.url}/recurring-invoices-create`}
    ...
    <Route
      exact
      path={`${match.url}/record-payment`}
      component={RecordPayment}
    />
    <Route
      exact
      path={`${match.url}/record-pay-wo-inv`}
      component={RecordPaywoInv}
    />
    ...
    <Route
      path={`${match.url}/create-credit-note`}
      component={CreateCreditNotes}
    />
    <Route
      path={`${match.url}/creditnotesinfo/:id`}
      component={CreditNotesInfo}
    />
  </Switch>
);
