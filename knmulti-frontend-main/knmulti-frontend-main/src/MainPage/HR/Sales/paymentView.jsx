import { Delete, Download, Email } from '@mui/icons-material';
...
const PaymentView = () => {
  ...
  const fetchPayment = async () => {
    toast
      .promise(httpService.get(`/sale-payment/${id}`), {
  ...
  const handleDelete = () => {
    toast
      .promise(httpService.delete(`/sale-payment/${id}`), {
        ...
        <div className="d-flex">
          ...
          <div className="p-2 ml-2 flex-fill">
            <div>
              ...
              <div className="ml-3">
                <Link
                  to={`/app/profile/customer-profile/${rPData?.customer?._id}`}
                >
                ...
                <div>
                  {rPData?.customer?.billingAddress?.city} -{' '}
                  {rPData?.customer?.billingAddress?.state}
                </div>
