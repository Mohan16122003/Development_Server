        ...
        <div className="page-header">
          <div className="row">
            <div className="col d-flex">
              ...
              <span className={creditData?.status == "CLOSED" ? 'badge bg-secondary p-2 h5 ml-2' : creditData?.status == "PARTIAL" ? 'badge bg-warning p-2 h5 ml-2' : 'badge bg-success p-2 h5 ml-2'}>{creditData?.status}</span>
            </div>
