          ...
          <div className='col-sm-12'>
            ...
            >
              ...
              <div className='submit-section'>
                ...
                <button onClick={e => handleSubmit({ ...e, submit: false })} type='submit' value='save'
                        className='btn btn-primary submit-btn'>Save
                </button>
              </div>
            </form>
          </div>
