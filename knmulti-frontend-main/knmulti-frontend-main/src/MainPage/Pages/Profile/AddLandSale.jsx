...
const AddLandSale = ({ fetchVendors, editVendorId }) => {
  ...
  const transactionTemplate = {
    itemDetails: landDetails.plotNo,
    transactionTemplate,
  ...
  const handleSubmit = async (e) => {
    ...
    toast
      .promise(httpService.post(`/landsale`, postData), {
    ...
    <div id="add_landsale" className="modal custom-modal fade" role="dialog">
      ...
      >
        <div
          ...
          style={{ scrollbarColor: 'gray', scrollbarWidth: '30px' }}
        >
            ...
            <form onSubmit={handleSubmit}>
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group">
                    <label>
                      Name of Land Owner <span className="text-danger">*</span>
                    </label>
                    <input
                      type="text"
              ...
              <div className="row">
                <div className="col-md-3">
                  <div className="form-group">
                    <label>
                      Total Amount11 <span className="text-danger">*</span>
                    </label>
                    <input
                      type="number"
                      className="form-control"
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="Purchase Agreement">
                        Purchase Agreement
                      </option>
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    <label>
                      Name of purchaser <span className="text-danger">*</span>
                    </label>
                    <input
                      type="text"
                      className="form-control"
