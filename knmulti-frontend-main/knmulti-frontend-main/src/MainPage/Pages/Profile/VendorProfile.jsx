...
const VendorProfile = () => {
  ...
  const isAdmin = user && user?.jobRole.name === 'Admin';
  ...
  let totalAmount = data.reduce((previousValue, currentValue) => {
    let amount = currentValue.credits
      ? previousValue + currentValue.credits
      : previousValue - currentValue.debits;
    return amount;
  }, 0);
  ...
  const removeFileFn = async (fileName) => {
    try {
      ...
      const resp = await httpService.put(`/vendor/${id}`, {
        userName: customer?.userName,
        fileInfos: customer?.fileInfos.filter(
  ...
  const fetchAllCredit = async () => {
    httpService
      .get(`/vendortrx/getvendorbillpayment?vendorId=${id}`)
      .then((res) => {
    ...
    <div className="page-wrapper">
                ...
                <div className="col-12">
                  <Stack justifyContent={'space-between'} direction={'row'}>
                    <Stack direction={'row'} alignItems={'center'} spacing={1}>
                      {customer?.fileInfos[0]?.filePath ? (
                        <img
                          src={customer.fileInfos[0].filePath}
                          width="120"
                          height="120"
                          alt="aaa"
                ...
                >
                  ...
                  >
                    ...
                    <div className="float-right">
                      <a
                        ...
                        style={{ color: 'black', marginLeft: '115px' }}
                      >
                        <EditIcon />
                      </a>
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        {customer?.otherDetails?.paymentTerms}
                      </span>
                    </Stack>
                    <Stack
                      direction={'row'}
                  ...
                  >
                    <div className="float-left">
                      ...
                      >
                        ...
                        &nbsp;&nbsp;Contact Details(
                        {customer?.personContact[0]?.firstName
                          ? customer?.personContact?.length
                          : 0}
                        )
                      </button>
                    </div>
            ...
            >
              ...
              >
                      ...
                      customer?.comments.map((c) => (
                        ...
                        >
                          ...
                          <div className="d-flex w-100 justify-content-between">
                            <h5 className="mb-1">
                              By {c?.createdBy?.firstName}{' '}
                              {c?.createdBy?.lastName} |{' '}
                              <small>
                                {dateFormatter(c?.date.split('T')[0])}
                ...
                <div className="tab-pane fade show" id="emp_notes">
                  ...
                  >
                    <h4 style={{ fontSize: '1rem' }}>Bill</h4>
                    <div>
                      ...
                      <Space size={'middle'} style={{ marginRight: '30px' }}>
                        <Link
                          to={`/app/purchase/bills?vendorId=${customer._id}`}
                        >
                          <a className="ant-btn">
                        ...
                        >
                          <i className="fa fa-plus m-r-5" /> Create
                        </Link>
                      </Space>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      {/* <Link
                        to={{
                          pathname: `/app/purchase/addexpense`,
                          state: { vendorId: customer._id },
                        }}
                      >
                        <button className="btn add-btn mr-3">
                      ...
                      <Link
                        to={`/app/purchase/expenses?vendorId=${customer._id}`}
                      >
                        <button className="btn add-btn mr-3">
                          <i className="fa fa-eye" />
                          View
                  ...
                  >
                    <h4 style={{ fontSize: '1rem' }}>Credit</h4>
                    <div>
                      {/* <Link
                        to={{
                          pathname: `/app/purchase/addvendorcredit`,
                          state: { vendorId: customer._id },
                        }}
                      >
                        <button className="btn add-btn mr-3">
                      ...
                      <Link
                        to={`/app/purchase/vendorcredit?vendorId=${customer._id}`}
                      >
                        <button className="btn add-btn mr-3">
                          <i className="fa fa-eye" />
                          View
                  ...
                  >
                    <h4 style={{ fontSize: '1rem' }}>Purchase Order</h4>
                    <div>
                      {/* <Link
                        to={{
                          pathname: `/app/purchase/addpurchaseorder`,
                          state: { vendorId: customer._id },
                        }}
                      >
                        <button className="btn add-btn mr-3">
                      ...
                      <Link
                        to={`/app/purchase/purchaseorder?vendorId=${customer._id}`}
                      >
                        <button className="btn add-btn mr-3">
                          <i className="fa fa-eye" />
                          View
                  ...
                  >
                    <h4 style={{ fontSize: '1rem' }}>Payments Made</h4>
                    <div>
                      {/* <Link
                        to={{
                      ...
                      <Link
                        to={`/app/purchase/paymentsmade?vendorId=${customer._id}`}
                      >
                        <button className="btn add-btn mr-3">
                          <i className="fa fa-eye" />
                          View
                ...
                <div id="emp_doc" className="pro-overview tab-pane fade show">
                  <h3>
                    Documents{' '}
                    <a
                      href="#"
                      ...
                      <ul className="list-group list-group-flush">
                        {customer?.fileInfos.map((file, index) => (
                          ...
                          >
                            ...
                            <Delete
                              onClick={() => removeFileFn(file?.fileName)}
                            />
                          </li>
                        ))}
                      </ul>
                      ...
                      <TableBody>
                        {allStock.map((l, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              {dateFormatter(l?.date?.split('T')[0])}
                            </TableCell>
                            ...
                            <TableCell>
                              <Link
                                to={`/app/projects/projects-view/${l?.projectId?._id}`}
                              >
                                {l?.projectId?.name}
                              </Link>
                            </TableCell>
      ...
      {customer?.billAddress && customer?.shipAddress && (
        <EditVendorAddress
          fetchVendors={fetchApi}
          editVendorId={id}
          bAddress={customer?.billAddress}
          sAddress={customer?.shipAddress}
        />
      )}
      {customer?.otherDetails && (
        <EditVendorOtherDetails
          fetchVendors={fetchApi}
          editVendorId={id}
          oDetails={customer?.otherDetails}
        />
      )}
      {customer?.personContact && (
        <EditVendorPersonContact
          fetchVendors={fetchApi}
          editVendorId={id}
          pContact={customer?.personContact}
        />
      )}
      {customer && (
        <AddVendorComment
          fetchVendors={fetchApi}
          editVendorId={id}
          vendorDetails={customer}
        />
      )}
      {customer && (
        <AddLandSale
          fetchVendors={fetchLandSale}
          editVendorId={id}
          vendorDetails={customer}
        />
      )}
      {customer && (
        <FileUploadModel
          modLink={`vendor/${customer?._id}`}
          filesInfo={customer?.fileInfos}
        />
      )}
      {customer && (
        <UploadDocument
          putLink={`/vendor/${id}`}
          fileInfoArr={customer?.fileInfos}
          fetchApi={fetchApi}
