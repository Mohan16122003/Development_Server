...
const VendorBillView = () => {
  ...
  useEffect(() => {
    toast
      .promise(httpService.get(`/vendortrx/getvendorbills?vendorId=${id}`), {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'projectId',
      render: (projectId) => (
        <span key={projectId?._id}>{projectId?.name}</span>
      ),
    },
    {
      title: 'Vendor Name',
        ...
        <div className="page-header">
          <div className="row">
            ...
            <div className="col-auto float-right ml-auto">
              <Link to="/app/purchase/addbill" className="btn add-btn">
