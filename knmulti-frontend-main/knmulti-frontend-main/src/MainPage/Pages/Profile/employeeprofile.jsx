...
const EmployeeProfile = () => {
  ...
  const [payslipSingleData, setPayslipSingleData] = useState(null);
  const {
    isAccountent,
    isAccountManager,
    isAdmin,
  ...
  const removeFileFn = async (fileName) => {
    try {
      ...
      const resp = await httpService.put(`/employee/${id}`, {
        userName: employee?.userName,
        fileInfos: employee?.fileInfos.filter(
  ...
  const removeCertFn = async (fileName) => {
    try {
      ...
      const resp = await httpService.put(`/employee/${id}`, {
        userName: employee?.userName,
        certFile: employee?.certFile.filter(
          (f) => f.fileName !== res?.data?.fileName
        ),
      });
      await fetchApi();
  ...
  useEffect(() => {
    employee.middleName && setmiddleName(employee?.middleName);
  }, [employee?.middleName]);
  ...
  return (
    <>
      {payslipRender === 'default' ? (
                        ...
                        <div className="col-12">
                          ...
                          >
                              ...
                              <Stack>
                                ...
                                <div>
                                  <span className={'badge bg-inverse-info'}>
                                    {employee?.jobRole?.authorities[0]}
                                  </span>
                                </div>
                              </Stack>
                            </Stack>
                            <Stack
                              ...
                              spacing={1}
                            >
                              <Link to={`/app/profile/addemployee/${id}`}>
                                <Button
                                  sx={{
                                    color: 'black',
                                    width: '18px',
                            ...
                            <Stack direction={'row'} marginBottom={1}>
                              ...
                              <div>
                                ...
                                {employee?.currentAddress?.addressLine1
                                  ?.concat(', ')
                                  ?.concat(employee?.currentAddress?.city || '')
                                  ?.concat(', ')
                                  ?.concat(
                                      ...
                                      <div className="experience-content">
                                        <div className="timeline-content">
                                          ...
                                          <span className="time">
                                            ...
                                            {
                                              employee?.resumeExp &&
                                                employee?.resumeExp?.length >
                                                  0 &&
                                                employee?.resumeExp.map(
                                                  (file, index) => (
                          ...
                          >
                            ...
                            >
                              ...
                              <span style={{ fontSize: '18px' }}>
                                (
                                {employee?.familyInformation[0]?.name
                                  ? employee?.familyInformation?.length
                                  : 0}
                                )
                              </span>
                            </button>
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            className="form-control"
                            defaultValue={employee?.currentAddress?.addressLine1
                              ?.concat(', ')
                              ?.concat(employee?.currentAddress?.addressLine1)
                              ?.concat(', ')
                              ?.concat(employee?.currentAddress?.city)}
                            onChange={(e) =>
                              setNewEmployeeDetails({
                                ...newEmployeeDetails,
                                currentAddress: {
                                  ...newEmployeeDetails.currentAddress,
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            className="form-control"
                            defaultValue={employee?.currentAddress?.state}
                            onChange={(e) =>
                              setNewEmployeeDetails({
                                ...newEmployeeDetails,
                                currentAddress: {
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            className="form-control"
                            defaultValue={employee?.currentAddress?.country}
                            onChange={(e) =>
                              setNewEmployeeDetails({
                                ...newEmployeeDetails,
                                currentAddress: {
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            className="form-control"
                            defaultValue={employee?.currentAddress?.postalCode}
                            onChange={(e) =>
                              setNewEmployeeDetails({
                                ...newEmployeeDetails,
                                currentAddress: {
            ...
            <>
              <EditEmpPersonal
                ...
                pData={{
                  ...
                  dob: new Date(employee?.dob || '2001-04-30T18:30:00.000Z'),
                  gender: employee?.gender,
                  mobileNo: employee?.mobileNo,
                  salary: employee?.salary,
                  jobRole: employee?.jobRole?._id,
                  workLocation: employee?.workLocation?._id,
                  department: employee?.department,
                }}
                addressData={employee?.address}
                setEmployee={fetchApi}
                userName={employee?.userName}
                isAdmin={isAdmin}
              />
              <EditEmpEdu
                empId={id}
                eduData={employee?.education}
                setEmployee={fetchApi}
                userName={employee?.userName}
              />
              <EditEmpExp
                empId={id}
                expData={employee?.previousExperience}
                setEmployee={fetchApi}
                userName={employee?.userName}
              />
              <EditEmpBank
                setEmployee={fetchApi}
                empId={id}
                bankData={employee?.bankDetails}
                userName={employee?.userName}
              />
              <EditEmpOtherDetails
                empId={id}
                oData={employee?.personalInformation}
                setEmployee={fetchApi}
                userName={employee?.userName}
              />
              <EditEmpContact
                empId={id}
                conData={employee?.familyInformation}
                setEmployee={fetchApi}
                userName={employee?.userName}
              />
              <UploadDocument
                putLink={`/employee/${id}`}
                fileInfoArr={employee?.fileInfos}
                certArr={employee?.certFile}
                fetchApi={fetchApi}
                userName={employee?.userName}
                cert={cert}
              />
        ...
        <Link to="/payslip" target="_blank">
          <Payslip
            employeeData={newEmployeeDetails}
            selectedPayslip={payslipSingleData}
