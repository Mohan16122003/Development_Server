...
import { addLeave, editLeave, fetchLeaves, fetchLeaveTypes } from '../../lib/api';
...
const HrleaveRequest = () => {
  ...
  const totalLeave = async (user, date) => {
  ...
  const selectEmployee = async (e) => {
    ...
    // totalLeave(empId);
    const employee = (await httpService.get(`/employee/${empId}`)).data;
    setSelectedEmp(employee);
    const employeeType = (await httpService.get(`/employee-type/${employee?.employeeType}`)).data;
  ...
  useEffect(async () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'noofdays',
        sorter: {
          compare: (a, b) => a?.noofdays - b.noofdays
        }
      },
      {
        title: 'Reason',
            ...
            <div className='row align-items-center'>
              <div className='col'>
                ...
                <ul className='breadcrumb'>
                  ...
                  <li className='breadcrumb-item active'> Employees Leaves</li>
                </ul>
              </div>
